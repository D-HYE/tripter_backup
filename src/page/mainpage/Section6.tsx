        ...
        <section className="section6 bg-[url('https://d-hye.github.io/source/img/main_img/bgimg1.jpg')] bg-no-repeat bg-[right_center] bg-cover">
            <div className="h-[18.75rem] md:h-[27.5rem] flex gap-8 flex-col-reverse md:flex-row items-center justify-center">
                <div className="qrimg">
                    ...
                    <Link to="#none" className={`block p-2 md:p-0 mt-5 text-center font-[theJamsil100] text-white ${hye.qrLink}`}>앱 다운로드</Link>
                </div>
                <div className="txt_box">
                    <h2 className="mb-4 text-trip-white font-[theJamsil400] text-semibig-text leading-[1.45] md:leading-[1]">나보다 나를 더 잘 아는 <span className="block md:inline font-[theJamsil400] text-semibig-text">최고의 여행 메이트</span></h2>
